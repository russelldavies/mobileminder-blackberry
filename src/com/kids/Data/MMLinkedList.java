...
/**
 * This method clears the elements in the array by initialising the object variables
 */
 ...
 * @param inputObj the object to to be added
 */
...
public boolean toArray(Object[] rtnArray)
{
	...
	{	
		int count = 0;
		for (MMLinkedListIterator theItr = this.getIterator(); theItr.isValid() && rtnArray.length > count; theItr.advance())
...
public void addValue(Object inputObj)
{
	if(null == next)
	{next = new MMListNode(this,inputObj);}
	else
	{next.addValue(inputObj);}
}
